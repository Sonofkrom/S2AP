...
6. (Recommended) In Duckstation, naviage to Settings > Game Properties > Emulation and set Runahead to "Disabled". Filler items may not apply correctly if this is enabled.
